    ...
    n.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = Fe(e)) ||
            ("function" ==
              typeof (n = J.call(t, "constructor") && t.constructor) &&
              tt.call(n) === Dt))
        );
      },
    ...
    (b = (function (e) {
          ...
          if (11 !== h && (p = pe.exec(e)))
            if ((c = p[1])) {
              ...
              if (
                ...
                return b.apply(n, t.getElementsByClassName(c)), n;
            }
          if (
            i.qsa &&
            !S[e + " "] &&
            ...
            if (((j = e), (m = t), 1 === h && (we.test(e) || re.test(e)))) {
              for (
                ((m = (Y.test(e) && I(t.parentNode)) || t) === t && i.scope) ||
                  ((u = t.getAttribute("id"))
                    ? (u = u.replace(se, oe))
      ...
      (v = o.setDocument =
        function (e) {
          var o,
            p,
            d = e ? e.ownerDocument || e : h;
          return (
            d != s &&
              9 === d.nodeType &&
              d.documentElement &&
              ((c = (s = d).documentElement),
              (l = !X(s)),
              h != s &&
                (o = s.defaultView) &&
                o.top !== o &&
              ...
              (i.scope = u(function (e) {
                return (
                  c.appendChild(e).appendChild(s.createElement("div")),
              ...
              (O = []),
              (r = []),
              (i.qsa = E.test(s.querySelectorAll)) &&
                (u(function (e) {
                  var t;
...
\\' msallowcapture=''><option selected=''></option></select>`),
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!i.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e == s || (e.ownerDocument == h && A(h, e))
                          ? -1
                          : t == s || (t.ownerDocument == h && A(h, t))
                          ? 1
                          : g
                          ? _(g, e) - _(g, t)
                          : 0
      ...
      (o.attr = function (e, n) {
        ...
        var a = t.attrHandle[n.toLowerCase()],
          o =
            a && ue.call(t.attrHandle, n.toLowerCase()) ? a(e, n, !l) : void 0;
        return void 0 !== o
          ? o
          : i.attributes || !l
          ? e.getAttribute(n)
      ...
      ((t = o.selectors =
        {
          ...
          pseudos: {
            ...
            lang: d(function (e) {
              return (
                ye.test(e || "") || o.error("unsupported lang: " + e),
        ...
        (k = o.tokenize =
          function (e, n) {
            ...
            for (s = e, l = [], d = t.preFilter; s; ) {
              for (r in ((a && !(i = Oe.exec(s))) ||
                (i && (s = s.slice(i[0].length) || s), l.push((c = []))),
              (a = !1),
              (i = re.exec(s)) &&
                ((a = i.shift()),
              ...
              (i = ce(
                ...
                (f = function (e, n, i, a, c) {
                  ...
                  for (
                    ...
                    if (m && d) {
                      for (
                        _ = 0, n || d.ownerDocument == s || (v(d), (i = !l));
                        (j = u[_++]);
  ...
  (n.filter = function (e, t, s) {
    ...
    n.fn.extend({
      ...
      is: function (e) {
        return !!he(
          this,
          "string" == typeof e && We.test(e) ? n(e) : e || [],
          !1
        ).length;
      },
    }),
      ...
      function (e, t) {
        n.fn[e] = function (s, o) {
          ...
          return (
            ...
            1 < this.length &&
              (gt[e] || n.uniqueSort(i), ft.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (n.Callbacks = function (e) {
    ...
    n.extend({
                    ...
                    h = function () {
                      ...
                      if (!(t < r)) {
                        ...
                        (n =
                          ...
                          o(n)
                            ? a
                              ? n.call(e, c(r, s, L, a), c(r, s, U, a))
                              : (r++,
                                n.call(
                                  e,
                                  c(r, s, L, a),
                                  c(r, s, U, a),
                                  c(r, s, L, s.notifyWith)
                                ))
                            : (i !== L && ((l = void 0), (d = [e])),
                              (a || s.resolveWith)(l, d));
                      }
      ...
      when: function (e) {
        ...
        if (
          a <= 1 &&
          (jt(e, s.done(c(t)).resolve, s.reject, !a),
  ...
  (n.fn.ready = function (e) {
    ...
    ("loading" !== i.readyState && !i.documentElement.doScroll)
      ...
      : (i.addEventListener("DOMContentLoaded", Y),
  ...
  function lt(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((o = "data-" + t.replace(Ot, "-$&").toLowerCase()),
    ...
    n.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((a = c.get(n)), 1 === n.nodeType && !s.get(n, "hasDataAttrs"))
          ) {
            for (i = r.length; i--; )
              r[i] &&
                0 === (o = r[i].name).indexOf("data-") &&
                ((o = f(o.slice(5))), lt(n, o, a[o]));
  ...
  y.getRootNode &&
    (z = function (e) {
      return (
        n.contains(e.ownerDocument, e) || e.getRootNode(Lt) === e.ownerDocument
      );
    }),
    (H = function (e, t) {
      return (
        "none" === (e = t || e).style.display ||
        ("" === e.style.display && z(e) && "none" === n.css(e, "display"))
      );
    });
  function ut(e, t, s, o) {
    var c,
    ...
    for (
      ...
      if ((a = e[u]) || 0 === a)
        if ("object" === k(a)) n.merge(f, a.nodeType ? [a] : a);
          ...
          for (
            c = c || d.appendChild(t.createElement("div")),
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            V.test(t.type) && t.click && d(t, "input") && q(t, "click", C), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            V.test(t.type) && t.click && d(t, "input") && q(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
          return (
            (V.test(t.type) && t.click && d(t, "input") && s.get(t, "click")) ||
            d(t, "a")
          );
        },
      },
  ...
  function E(e, t, i, c) {
    ...
    if (
      p &&
      ((v = (h = Ne(t, e[0].ownerDocument, !1, e, c)).firstChild),
      ...
      for (m = (u = n.map(r(h, "script"), $t)).length; d < p; d++)
        (l = h),
          d !== j &&
            ((l = n.clone(l, !0, !0)), m && n.merge(u, r(l, "script"))),
          i.call(e[d], l, d);
      if (m)
        for (f = u[u.length - 1].ownerDocument, n.map(u, Vt), d = 0; d < m; d++)
          (l = u[d]),
            Xe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : He(l.textContent.replace(Kt, ""), l, f));
    }
    return e;
  }
  function De(e, t, s) {
    for (var o, a = t ? n.filter(t, e) : e, i = 0; null != (o = a[i]); i++)
      s || 1 !== o.nodeType || n.cleanData(r(o)),
        o.parentNode &&
          (s && z(o) && ve(r(o, "script")), o.parentNode.removeChild(o));
    return e;
  }
  n.extend({
    ...
    clone: function (e, t, s) {
      ...
      if (
        ...
        for (i = r(l), o = 0, d = (c = r(e)).length; o < d; o++)
          (u = c[o]),
            (h = i[o]),
            void 0,
            "input" === (m = h.nodeName.toLowerCase()) && V.test(u.type)
              ? (h.checked = u.checked)
              : ("input" !== m && "textarea" !== m) ||
                (h.defaultValue = u.defaultValue);
      if (t)
        if (s)
          for (c = c || r(e), i = i || r(l), o = 0, d = c.length; o < d; o++)
            Te(c[o], i[o]);
        else Te(e, l);
    ...
    n.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (n.cleanData(r(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return v(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Nt.test(e) &&
              !l[(et.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = n.htmlPrefilter(e);
              try {
                for (; s < o; s++)
                  1 === (t = this[s] || {}).nodeType &&
                    (n.cleanData(r(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch {}
            }
      ...
      replaceWith: function () {
        ...
        return E(
          ...
          function (t) {
            ...
            n.inArray(this, e) < 0 &&
              (n.cleanData(r(this)), s && s.replaceChild(t, this));
          },
          e
        );
      },
    ...
    return (
      ...
      (e in Ve
        ...
        : ($e[e] =
            (function (e) {
              for (
                var n = e[0].toUpperCase() + e.slice(1), t = Be.length;
                t--;
  ...
  function fe(e, t, s, o, i, a) {
    ...
    for (; r < 4; r += 2)
      "margin" === s && (c += n.css(e, s + p[r], !0, i)),
        o
          ? ("content" === s && (c -= n.css(e, "padding" + p[r], !0, i)),
            "margin" !== s && (c -= n.css(e, "border" + p[r] + "Width", !0, i)))
          : ((c += n.css(e, "padding" + p[r], !0, i)),
            "padding" !== s
              ? (c += n.css(e, "border" + p[r] + "Width", !0, i))
              : (l += n.css(e, "border" + p[r] + "Width", !0, i)));
    return (
      !o &&
        0 <= a &&
        (c +=
  ...
  function Qe(e, t, s) {
    ...
    return (
      ((!a.boxSizingReliable() && r) ||
        ...
        (c = l in e) && (o = e[l])),
      (o = parseFloat(o) || 0) +
        fe(e, t, s || (r ? "border" : "content"), c, i, o) +
        "px"
    );
  }
  ...
  n.extend({
    ...
    style: function (e, t, s, o) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          c = e.style;
        if (
          (u || (t = ge(d)), (r = n.cssHooks[t] || n.cssHooks[d]), void 0 === s)
        )
    ...
    n.each(["height", "width"], function (e, t) {
      n.cssHooks[t] = {
        get: function (e, s, o) {
          if (s)
            return !It.test(n.css(e, "display")) ||
      ...
      _default: {
        ...
        set: function (e) {
          n.fx.step[e.prop]
            ? n.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!n.cssHooks[e.prop] && null == e.elem.style[ge(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function m(e, t, s) {
    ...
    return (
      ...
      n.fx.timer(n.extend(u, { elem: e, anim: i, queue: i.opts.queue })),
      i
    );
  }
        ...
        if ((l = !n.isEmptyObject(t)) || !n.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              h && F([e], !0),
              m.done(function () {
                for (i in (h || F([e]), s.remove(e, "fxshow"), f))
                  n.style(e, i, f[i]);
              })),
              (l = ct(h ? a[i] : 0, i, m)),
              i in a ||
      ...
      stop: function (e, t, o) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in a) a[t] && a[t].stop && ot.test(t) && i(a[t]);
            for (t = r.length; t--; )
              r[t].elem !== this ||
                (e != null && r[t].queue !== e) ||
          ...
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === a && n.isXMLDoc(e)) ||
                (o =
                  ...
                  (n.expr.match.bool.test(t) ? dt : void 0)),
              void 0 !== s
                ? null === s
    ...
    n.extend(n.event, {
      trigger: function (t, a, r, c) {
        ...
        if (
          ...
          if (!c && !h.noBubble && !D(r)) {
            for (
              j = h.delegateType || l, me.test(j + l) || (d = d.parentNode);
              d;
              d = d.parentNode
            )
              g.push(d), (u = d);
...
`)
  ...
  function ne(e, t, s, o) {
    ...
    else for (i in t) ne(e + "[" + i + "]", t[i], s, o);
  }
...
`
  ...
  return (
      ...
      ajax: function (t, s) {
        ...
        if (
          ...
          try {
            (d.href = o.url),
              (d.href = d.href),
              (o.crossDomain =
                se.protocol + "//" + se.host != d.protocol + "//" + d.host);
          } catch {
            o.crossDomain = !0;
          }
        }
        ...
        o.hasContent
          ? o.data &&
            ...
            (o.data = o.data.replace(At, "+"))
          : ((p = o.url.slice(r.length)),
            o.data &&
              (o.processData || "string" == typeof o.data) &&
              ((r += (re.test(r) ? "&" : "?") + o.data), delete o.data),
            !1 === o.cache &&
              ((r = r.replace(Mt, "$1")),
            ...
            h
              ? (o.ifModified &&
                ...
                204 === t || "HEAD" === o.type
                  ...
                  : 304 === t
                  ? (u = "notmodified")
                  : ((u = p.state), (x = p.data), (h = !(v = p.error))))
    ...
    n.ajaxPrefilter("json jsonp", function (t, s, i) {
      ...
      if (l || "jsonp" === t.dataTypes[0])
        return (
          ...
          l
            ? (t[l] = t[l].replace(K, "$1" + a))
            : !1 !== t.jsonp &&
              (t.url += (re.test(t.url) ? "&" : "?") + t.jsonp + "=" + a),
          ...
          i.always(function () {
            void 0 === r ? n(e).removeProp(a) : (e[a] = r),
              t[a] && ((t.jsonpCallback = s.jsonpCallback), Oe.push(a)),
              c && o(r) && r(c[0]),
              (c = r = void 0);
          }),
          "script"
    ...
    (a.createHTMLDocument =
      (((Me = i.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (n.fn.load = function (e, t, s) {
      var i,
        ...
        r = e.indexOf(" ");
      return (
        -1 < r && ((i = _(e.slice(r))), (e = e.slice(0, r))),
        o(t)
          ? ((s = t), (t = void 0))
